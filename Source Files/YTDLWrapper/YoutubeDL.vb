...
Public Class YoutubeDL
    ...
    Public Function IsYoutubeLink(URL As String) As Boolean
        ...
        'youtu.be
        If URL.ToLower.Contains("youtube.be") Then Return True
        Return False
    End Function
    Public Async Function GetVideo(URL As String, Q As YoutubeVideo.Quality) As Task(Of YoutubeVideo)
        Return Await Task.Run(Function()
                              ...
                              End Function)
    End Function
    Public Async Function RequestAndDumpInfo(URL As String) As Task(Of YoutubeVideo)
        ...
        Dim Artists = ParsedInfo("artist").ToString.Split(",")
